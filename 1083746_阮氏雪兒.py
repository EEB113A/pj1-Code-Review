    ...
    def check_neko(self):
        ...
        for y in range(1, 9):
            for x in range(1, 7):
                ...
                #For left-crossed line
                    if self.check[y][x] == self.check[y-1][x-1] and self.check[y][x] == self.check[y+1][x+1]:
                        self.neko[y-1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x+1] = 7
                        
                #For right-crossed line  
                    elif self.check[y+1][x-1] == self.check[y][x] and self.check[y][x] == self.check[y-1][x+1]:
                        self.neko[y+1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y-1][x+1] = 7
...
#========================================================= Question 3 =========================================================
    #Check whether the cat block reaches the top of the map or not
    def over_neko(self):
        for x in range(8):
            if self.neko[0][x] > 0:
                return True
