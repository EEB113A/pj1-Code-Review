...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x-1] == self.check[y][x] and self.check[y+1][x+1] == self.check[y][x] and self.check[y+1][x-1] == self.check[y][x] and self.check[y-1][x+1] == self.check[y][x]:
                        self.neko[y-1][x] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x] = 7
                        self.neko[y-1][x] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x] = 7   #X型
                    elif self.check[y-1][x-1] == self.check[y][x] and self.check[y+1][x+1] == self.check[y][x]:
                        self.neko[y-1][x] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x] = 7  #右斜 
                    elif self.check[y+1][x-1] == self.check[y][x] and self.check[y-1][x+1] == self.check[y][x]:
                        self.neko[y-1][x] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x] = 7   #左斜
...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        for y in range (8,-1,-1):
            for x in range (8):
                  if  self.neko[y+1][x]==0 :#判斷下方是否有方塊 
