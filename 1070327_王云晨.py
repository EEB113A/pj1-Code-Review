...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x-1] == self.check[y][x] and self.check[y+1][x+1] == self.check[y][x]: #左斜線
                        self.neko[y-1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x+1] = 7 
                    if self.check[y+1][x-1] == self.check[y][x] and self.check[y-1][x+1] == self.check[y][x]: #右斜線
                        self.neko[y+1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y-1][x+1] = 7
    ...
    def drop_neko(self):
        ...
        for y in range(9):
            for x in range(8):
                    if self.neko[y+1][x] == 0:   #若下方無方塊
                       self.neko[y+1][x] = self.neko[y][x] #則往下格落下
                       self.neko[y][x] = 0                 #原方塊之圖案消失
                    if self.neko[y][x] > 0:   
                       self.cnt += 1
                    if self.cnt == 10:
                       self.cnt = 0
