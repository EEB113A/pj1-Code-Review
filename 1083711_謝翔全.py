            ...
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y][x-1] == self.check[y][x] and self.check[y][x+1] == self.check[y][x]:
                        self.neko[y][x-1] = 7 #左邊
                        self.neko[y][x] = 7 #擺放方塊位置
                        self.neko[y][x+1] = 7 #右邊
            ...
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x-1] == self.check[y][x] and self.check[y+1][x+1] == self.check[y][x]:
                        self.neko[y-1][x-1] = 7 #左下
                        self.neko[y][x] = 7 #擺放方塊位置
                        self.neko[y+1][x+1] = 7 #右上
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x+1] == self.check[y][x] and self.check[y+1][x-1] == self.check[y][x]:
                        self.neko[y-1][x+1] = 7 #左上
                        self.neko[y][x] = 7 #擺放方塊位置
                        self.neko[y+1][x-1] = 7 #右下
...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        for y in range(0,9): 
            for x in range(8):
                if self.neko[9-y][x] == 0: #確認是否有方塊
                    #方塊落下
                    self.neko[9-y][x] = self.neko[(9-y)-1][x] 
                    self.neko[(9-y)-1][x] = 0
                if 
#========================================================= Question 3 =========================================================
    # 題目說明：
