...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        for x in range(8):                         
            for y in range(9):   
                if self.neko[y][x]>0 :                      #當有貓咪要落下
                    if self.neko[y+1][x]==0:                #判斷貓咪下落的下一層沒有東西            
                        self.neko[y+1][x]=self.neko[y][x]   #則貓咪落到下一層
                        self.neko[y][x]=0                   #原來那層貓咪消失
                        break
        
        for i in range(8):                         
            for j in range(1,10):                               
                if self.neko[j][i]==0 :                     #判斷還可不可以下落
                    if self.neko[j-1][i]!=0 :
                        down =  False
...
#========================================================= Question 3 =========================================================
    ...
    def over_neko(self):
        ...
        touch = False
        for j in range (8):
            if self.neko[0][j]>0:       # 判斷貓咪是否碰到到最上層
