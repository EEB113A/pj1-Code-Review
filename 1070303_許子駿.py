...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        # <<<將你的程式寫在這邊>>>
        for y in range(8,-1,-1):#這邊用倒數使他可以一格一格落下
            for x in range(8):
        ...
        for y in range(8,-1,-1):
            for x in range(8):  
                if self.neko[y+1][x]==0 and self.neko[y][x]>0:#原位置的下面一格沒有方塊且原位置有方塊則變數a=False
                    a=False
...
#========================================================= Question 3 =========================================================
    ...
    def over_neko(self):
        ...
        for y in range(8,-1,-1):
            for x in range(8): 
                if self.neko[y+1][x]>0 and self.neko[y][x]>0 and y==0:#原位置的下面一格有方塊且原位置有方塊並且y==0(在天花板)則變數a=True
                    a=True
        if a==True:
            return True
        else:
